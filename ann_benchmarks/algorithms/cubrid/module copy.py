...
class CUBVEC(BaseANN):
        ...
        try:
            try:
                ...
                if (self._signature == self._signature_base):
                    self._signature += "_" + str(total_rows) + "_" + str(dim)
                ...
                for start in range(0, total_rows, batch_size):
                    ...
                    # if the flag file exists, skip the following
                ...
                try:
                    cur.execute(f"SELECT COUNT(*) FROM {self._signature};")
    ...
    def query(self, v, n):
        ...
        args = (vector_str, n)
        self._cur.execute(query_str, args)
